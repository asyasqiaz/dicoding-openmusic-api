...
exports.down = (pgm) => {
  pgm.deleteConstraint('user_album_likes', 'fk_user_album_likes.user_id_users.id');
  pgm.deleteConstraint('user_album_likes', 'fk_user_album_likes.album_id_albums.id');
